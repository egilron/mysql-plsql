...
/*
Her skal vi gjøre endringer slik at fila kjører på Oracle.
Formålet er å lære språket gjennomendringene,
og lære sql gjennom spørringer når vi får dataene på plass 
...
CREATE TABLE terms
(
  terms_id       INT     GENERATED    BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
...
(
  vendor_id                     INT   GENERATED    BY DEFAULT ON NULL AS IDENTITY,
...
);/* Denne flytter vi nedover ettersom det over fungerer i PL/SQL      
